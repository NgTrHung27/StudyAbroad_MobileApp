...
UserAuthLogin userAuthLoginFromJson(String str) => UserAuthLogin.fromJson(json.decode(str));
...
class ScholarshipScholarship {
    ...
    factory ScholarshipScholarship.fromJson(Map<String, dynamic> json) => ScholarshipScholarship(
        id: json["id"],
        name: json["name"],
