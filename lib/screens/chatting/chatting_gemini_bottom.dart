...
class _GeminiAIState extends State<GeminiAI> {
  ...
  ChatUser currentUser = ChatUser(id: "0", firstName: "Trung Hung");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: textColorRed),
          onPressed: () => Navigator.of(context).pop(),
        ),
      ),
      body: _buildUI(redCorlor, subtitle, hintText, textColor),
    );
  }

  Widget _buildUI(redCorlor, subtitle, hintText, textColor) {
    return Padding(
            ...
            sendButtonBuilder: (send) {
              return IconButton(
                icon: Icon(Icons.send,
                    color: redCorlor), // Sử dụng biến redCorlor để set màu
                onPressed: send,
              );
            },
            trailing: [
